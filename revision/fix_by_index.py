...
disc = [
    ...
    # ensure it uses \n instead of \r\n for consistency if needed, but splitlines with keepends=True does the trick
    fixed_lines = [line + '\n' for line in fixed_lines_str.split('\n')]
    
    # We replace from index 893 to 913
    lines[893:913] = fixed_lines
    
    with open(target, "w", encoding="utf-8") as f:
        f.writelines(lines)
        
    print("Fixed corrupted block by index.")
